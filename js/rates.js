...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const shipFromSelectDownIcon = document.getElementById(
    "shipFromSelectDownIcon"
  );
  const shipFromSelectUpIcon = document.getElementById("shipFromSelectUpIcon");
  ...
  shipFromSelect.addEventListener("click", () => {
    ...
    if (checkedBoxes.ShipFrom) {
      ...
      shipFromSelectDownIcon.classList.add("hidden");
      shipFromSelectUpIcon.classList.remove("hidden");
    } else {
      ...
      shipFromSelectDownIcon.classList.remove("hidden");
      shipFromSelectUpIcon.classList.add("hidden");
    }
  });
});
